...
Vector2::Vector2(float lst[2]) {
    x = lst[0];
    y = lst[1];
}

Vector2::Vector2(std::vector<float> lst) {
    assert(lst.size() == 2);
    x = lst[0];
    y = lst[1];
}
...
float Vector2::dotc(const Vector2& v1) {
...
Vector3::Vector3(float lst[3]) {
    x = lst[0];
    y = lst[1];
    z = lst[2];
}

Vector3::Vector3(std::vector<float> lst) {
    assert(lst.size() == 3);
    x = lst[0];
    y = lst[1];
    z = lst[2];
...
float Vector3::dotc(const Vector3& v1) {
...
Vector4::Vector4(std::vector<float> lst) {
    assert(lst.size() == 4);
    x = lst[0];
    y = lst[1];
    z = lst[2];
...
float Vector4::dotc(const Vector4& v1) {
